...
///////// Gloss:
                float gloss = 0.4;
                float perceptualRoughness = 1.0 - 0.4;
...
////// Specular:
                ...
                float node_331 = 1.0;
                float3 diffuseColor = (lerp(float3(node_331,node_331,node_331),float3(0.9632353,0.8224623,0.03541304),i.vertexColor.b)*_Diffuse_var.rgb); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float specularMonochrome;
                float3 specColor;
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, 0.2, specColor, specularMonochrome );
