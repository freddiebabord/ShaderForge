...
Shader "Shader Forge/Examples/TessellationDisplacement" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma exclude_renderers d3d9 d3d11 glcore gles3 metal d3d11_9x xboxone ps4 psp2 
            #pragma target 5.0
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_5208 = _Time;
                    float2 node_6 = (v.texcoord0*2.0);
                    float2 node_161 = (node_6+node_5208.g*float2(0.4,0));
                    float node_15 = 1.0;
...
///////// Gloss:
                float gloss = 10.0;
                float perceptualRoughness = 1.0 - 10.0;
...
////// Specular:
                ...
                float3 specularColor = (node_156*node_162.r);
                float specularMonochrome;
                float3 diffuseColor = node_162; // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_529 = _Time;
                    float2 node_6 = (v.texcoord0*2.0);
                    float2 node_161 = (node_6+node_529.g*float2(0.4,0));
                    float node_15 = 1.0;
                    float4 _DisplacementR_var = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_803 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz += (v.normal*((1.0 - max(_DisplacementR_var.r,node_803.a))*((-1.0)*_Depth)));
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    ...
                    float2 node_6 = (v.texcoord0*2.0);
                    float2 node_161 = (node_6+node_1397.g*float2(0.4,0));
                    float node_15 = 1.0;
                    float4 _DisplacementR_var = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_803 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz += (v.normal*((1.0 - max(_DisplacementR_var.r,node_803.a))*((-1.0)*_Depth)));
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_5381 = _Time;
                    float2 node_6 = (v.texcoord0*2.0);
                    float2 node_161 = (node_6+node_5381.g*float2(0.4,0));
                    float node_15 = 1.0;
                    float4 _DisplacementR_var = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_803 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz += (v.normal*((1.0 - max(_DisplacementR_var.r,node_803.a))*((-1.0)*_Depth)));
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float specularMonochrome;
                float3 specColor;
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, (node_156*node_162.r), specColor, specularMonochrome );
